      ...
      // Analyst Signature
      {
        columns: [
          { width: '50%', text: '' },
          {
            width: '50%',
            stack: [
              { text: 'Analyst Name', italics: true, fontSize: 10, alignment: 'right', margin: [0, 0, 0, 0] },
              { text: (doctorInfo.name || 'Analyst Name').toUpperCase(), bold: true, fontSize: 9, alignment: 'right', margin: [0, 5, 0, 0] }
            ]
          }
        ]
      },
