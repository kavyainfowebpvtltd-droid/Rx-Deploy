...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(UserRepository userRepository, MedicalServiceRepository serviceRepository,
        ...
        return args -> {
            ...
            if (!userRepository.findByEmail("mramteke80@gmail.com").isPresent()) {
                User admin = new User();
                admin.setEmail("mramteke80@gmail.com");
            ...
            for (Order order : allOrders) {
                ...
                // Placeholder references used during submission must never be treated as
                // payment.
