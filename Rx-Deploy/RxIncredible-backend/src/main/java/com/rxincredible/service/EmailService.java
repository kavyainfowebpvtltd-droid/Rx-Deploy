...
public class EmailService {
    ...
    private String buildPrescriptionEmailBody(Order order, User user) {
        ...
        // if (order.getAssignedDoctor() != null) {
        // body.append("\nAnalyst:
        // ").append(order.getAssignedDoctor().getFullName()).append("\n");
        // }

        if (order.getAssignedDoctor() != null) {
            User assigned = order.getAssignedDoctor();

            String roleLabel = "Professional";
            String name = assigned.getFullName();

            if (assigned.getRole() != null) {
                String role = assigned.getRole().toUpperCase();
            ...
            body.append("\n").append(roleLabel).append(": ").append(name).append("\n");
        }
        body.append("\n");
